...
- [`poster_code/`](./poster_code): LaTeX source of the master thesis' poster
...
- The LaTeX source of the thesis lives in [`paper_code/`](./paper_code) and the poster source in [`poster_code/`](./poster_code) (for both, `main.tex` is the entry point).
