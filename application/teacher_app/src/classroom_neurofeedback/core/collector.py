            ...
            with self._lock:
                ...
                for idx, sample in enumerate(samples):
                    ...
                    for attention in attention_updates:
                        ...
                        # Use received_ts (local PC clock) so timestamps are
                        # comparable to local_clock() calls in the report capture.
                        state.attention_history.append((received_ts, attention))
